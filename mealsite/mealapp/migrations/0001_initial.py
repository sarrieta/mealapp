# Generated by Django 2.0.10 on 2019-01-27 16:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opening', models.CharField(default=None, max_length=30)),
                ('long', models.DecimalField(decimal_places=6, max_digits=9)),
                ('lat', models.DecimalField(decimal_places=6, max_digits=9)),
                ('menu_items', models.ManyToManyField(blank=True, related_name='related_to', to='mealapp.Menu_Items')),
            ],
            options={
